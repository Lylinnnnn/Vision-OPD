...
apply_model_profile_defaults() {
    ...
    case "$profile" in
        ...
        qwen3vl_8b_thinking)
            ...
            [[ -z "$VISION_MAX_TOKENS_WAS_SET" ]] && VISION_MAX_TOKENS="${THINKING_8B_VISION_MAX_TOKENS:-3072}"
            [[ -z "$VISION_MAX_TOKENS_WAS_SET" ]] && VISION_MAX_TOKENS_WAS_SET="profile"
        ...
        generic_thinking)
            ...
            [[ -z "$VISION_MAX_TOKENS_WAS_SET" ]] && VISION_MAX_TOKENS="${THINKING_VISION_MAX_TOKENS:-3072}"
            [[ -z "$VISION_MAX_TOKENS_WAS_SET" ]] && VISION_MAX_TOKENS_WAS_SET="profile"

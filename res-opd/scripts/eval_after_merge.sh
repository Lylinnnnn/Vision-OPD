...
apply_model_profile_defaults() {
    ...
    case "$profile" in
        qwen3vl_2b_thinking)
            ...
            [[ -z "$VISION_MAX_TOKENS_WAS_SET" ]] && VISION_MAX_TOKENS="${THINKING_2B_VISION_MAX_TOKENS:-$EVAL_THINKING_MAX_TOKENS}"
            ...
            [[ -z "$POPE_MAX_NEW_TOKENS_WAS_SET" ]] && POPE_MAX_NEW_TOKENS="${THINKING_2B_POPE_MAX_NEW_TOKENS:-$EVAL_THINKING_MAX_TOKENS}"
            [[ -z "$POPE_PARALLEL_WORKERS_WAS_SET" ]] && POPE_PARALLEL_WORKERS="${THINKING_2B_POPE_PARALLEL_WORKERS:-24}"
            [[ -z "$AMBER_MAX_NEW_TOKENS_GENERATIVE_WAS_SET" ]] && AMBER_MAX_NEW_TOKENS_GENERATIVE="${THINKING_2B_AMBER_MAX_NEW_TOKENS_GENERATIVE:-$EVAL_THINKING_MAX_TOKENS}"
            [[ -z "$AMBER_MAX_NEW_TOKENS_DISCRIMINATIVE_WAS_SET" ]] && AMBER_MAX_NEW_TOKENS_DISCRIMINATIVE="${THINKING_2B_AMBER_MAX_NEW_TOKENS_DISCRIMINATIVE:-$EVAL_THINKING_MAX_TOKENS}"
            [[ -z "$AMBER_PARALLEL_WORKERS_WAS_SET" ]] && AMBER_PARALLEL_WORKERS="${THINKING_2B_AMBER_PARALLEL_WORKERS:-8}"
            [[ -z "$CHAIR_MAX_NEW_TOKENS_WAS_SET" ]] && CHAIR_MAX_NEW_TOKENS="${THINKING_2B_CHAIR_MAX_NEW_TOKENS:-$EVAL_THINKING_MAX_TOKENS}"
        ...
        qwen3vl_8b_thinking)
            ...
            [[ -z "$VLLM_MAX_MODEL_LEN_WAS_SET" ]] && VLLM_MAX_MODEL_LEN="${THINKING_8B_VLLM_MAX_MODEL_LEN:-16384}"
            [[ -z "$VLLM_MAX_NUM_SEQS_WAS_SET" ]] && VLLM_MAX_NUM_SEQS="${THINKING_8B_VLLM_MAX_NUM_SEQS:-8}"
            [[ -z "$VISION_MAX_TOKENS_WAS_SET" ]] && VISION_MAX_TOKENS="${THINKING_8B_VISION_MAX_TOKENS:-$EVAL_THINKING_MAX_TOKENS}"
            [[ -z "$VISION_MAX_TOKENS_WAS_SET" ]] && VISION_MAX_TOKENS_WAS_SET="profile"
            [[ -z "$VISION_PARALLEL_WORKERS_WAS_SET" ]] && VISION_PARALLEL_WORKERS="${THINKING_8B_VISION_PARALLEL_WORKERS:-16}"
            [[ -z "$POPE_MAX_NEW_TOKENS_WAS_SET" ]] && POPE_MAX_NEW_TOKENS="${THINKING_8B_POPE_MAX_NEW_TOKENS:-$EVAL_THINKING_MAX_TOKENS}"
            [[ -z "$POPE_PARALLEL_WORKERS_WAS_SET" ]] && POPE_PARALLEL_WORKERS="${THINKING_8B_POPE_PARALLEL_WORKERS:-8}"
            [[ -z "$AMBER_MAX_NEW_TOKENS_GENERATIVE_WAS_SET" ]] && AMBER_MAX_NEW_TOKENS_GENERATIVE="${THINKING_8B_AMBER_MAX_NEW_TOKENS_GENERATIVE:-$EVAL_THINKING_MAX_TOKENS}"
            [[ -z "$AMBER_MAX_NEW_TOKENS_DISCRIMINATIVE_WAS_SET" ]] && AMBER_MAX_NEW_TOKENS_DISCRIMINATIVE="${THINKING_8B_AMBER_MAX_NEW_TOKENS_DISCRIMINATIVE:-$EVAL_THINKING_MAX_TOKENS}"
            [[ -z "$AMBER_PARALLEL_WORKERS_WAS_SET" ]] && AMBER_PARALLEL_WORKERS="${THINKING_8B_AMBER_PARALLEL_WORKERS:-4}"
            [[ -z "$CHAIR_MAX_NEW_TOKENS_WAS_SET" ]] && CHAIR_MAX_NEW_TOKENS="${THINKING_8B_CHAIR_MAX_NEW_TOKENS:-$EVAL_THINKING_MAX_TOKENS}"
        ...
        generic_thinking)
            ...
            [[ -z "$VLLM_CUSTOM_OPS_WAS_SET" ]] && VLLM_CUSTOM_OPS="none"
            [[ -z "$VLLM_TENSOR_PARALLEL_SIZE_WAS_SET" ]] && VLLM_TENSOR_PARALLEL_SIZE="8"
            [[ -z "$VLLM_MAX_MODEL_LEN_WAS_SET" ]] && VLLM_MAX_MODEL_LEN="${THINKING_VLLM_MAX_MODEL_LEN:-16384}"
            [[ -z "$VLLM_MAX_NUM_SEQS_WAS_SET" ]] && VLLM_MAX_NUM_SEQS="${THINKING_VLLM_MAX_NUM_SEQS:-8}"
            [[ -z "$VISION_MAX_TOKENS_WAS_SET" ]] && VISION_MAX_TOKENS="${THINKING_VISION_MAX_TOKENS:-$EVAL_THINKING_MAX_TOKENS}"
            [[ -z "$VISION_MAX_TOKENS_WAS_SET" ]] && VISION_MAX_TOKENS_WAS_SET="profile"
            [[ -z "$VISION_PARALLEL_WORKERS_WAS_SET" ]] && VISION_PARALLEL_WORKERS="${THINKING_VISION_PARALLEL_WORKERS:-16}"
            [[ -z "$POPE_MAX_NEW_TOKENS_WAS_SET" ]] && POPE_MAX_NEW_TOKENS="${THINKING_POPE_MAX_NEW_TOKENS:-$EVAL_THINKING_MAX_TOKENS}"
            [[ -z "$POPE_PARALLEL_WORKERS_WAS_SET" ]] && POPE_PARALLEL_WORKERS="${THINKING_POPE_PARALLEL_WORKERS:-8}"
            [[ -z "$AMBER_MAX_NEW_TOKENS_GENERATIVE_WAS_SET" ]] && AMBER_MAX_NEW_TOKENS_GENERATIVE="${THINKING_AMBER_MAX_NEW_TOKENS_GENERATIVE:-$EVAL_THINKING_MAX_TOKENS}"
            [[ -z "$AMBER_MAX_NEW_TOKENS_DISCRIMINATIVE_WAS_SET" ]] && AMBER_MAX_NEW_TOKENS_DISCRIMINATIVE="${THINKING_AMBER_MAX_NEW_TOKENS_DISCRIMINATIVE:-$EVAL_THINKING_MAX_TOKENS}"
            [[ -z "$AMBER_PARALLEL_WORKERS_WAS_SET" ]] && AMBER_PARALLEL_WORKERS="${THINKING_AMBER_PARALLEL_WORKERS:-4}"
            [[ -z "$CHAIR_MAX_NEW_TOKENS_WAS_SET" ]] && CHAIR_MAX_NEW_TOKENS="${THINKING_CHAIR_MAX_NEW_TOKENS:-$EVAL_THINKING_MAX_TOKENS}"

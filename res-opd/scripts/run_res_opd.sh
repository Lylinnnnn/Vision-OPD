...
#     bash res-opd/scripts/run_res_opd.sh
#
#   # OPD-baseline-first protection: only weaken likely-safe tokens; risk tokens
#   # return to raw frozen RKL weight and are not boosted.
#   DEGRADATION_MODE=original STUDENT_RATIO=1.0 TEACHER_RATIO=0.75 \
#     TEACHER_MODE=frozen ALPHA=1.0 OPD_SELECTIVE_WEIGHT=True \
...
if [[ "$OPD_SELECTIVE_WEIGHT_MODE" == "protect_risk_unprotect" ]]; then
    OPD_SELECTIVE_WEIGHT_UNCERTAINTY_MODE="${OPD_SELECTIVE_WEIGHT_UNCERTAINTY_MODE:-entropy_or_nll}"
    OPD_SELECTIVE_WEIGHT_TIERED_PROTECT="${OPD_SELECTIVE_WEIGHT_TIERED_PROTECT:-True}"
    ...
    OPD_SELECTIVE_WEIGHT_ENTROPY_HIGH_Q="${OPD_SELECTIVE_WEIGHT_ENTROPY_HIGH_Q:-0.80}"
    OPD_SELECTIVE_WEIGHT_NLL_HIGH_Q="${OPD_SELECTIVE_WEIGHT_NLL_HIGH_Q:-0.80}"
    OPD_SELECTIVE_WEIGHT_LOSS_HIGH_Q="${OPD_SELECTIVE_WEIGHT_LOSS_HIGH_Q:-0.90}"
    ...
    OPD_SELECTIVE_WEIGHT_PROTECT="${OPD_SELECTIVE_WEIGHT_PROTECT:-0.75}"
    OPD_SELECTIVE_WEIGHT_UNCLEAR="${OPD_SELECTIVE_WEIGHT_UNCLEAR:-0.75}"
else
...
echo "Selective weight: $OPD_SELECTIVE_WEIGHT (mode=$OPD_SELECTIVE_WEIGHT_MODE, uncertainty=$OPD_SELECTIVE_WEIGHT_UNCERTAINTY_MODE, tiered=$OPD_SELECTIVE_WEIGHT_TIERED_PROTECT, normalize=$OPD_SELECTIVE_WEIGHT_NORMALIZE, entropy_q=${OPD_SELECTIVE_WEIGHT_ENTROPY_LOW_Q}/${OPD_SELECTIVE_WEIGHT_ENTROPY_HIGH_Q}, nll_q=${OPD_SELECTIVE_WEIGHT_NLL_LOW_Q}/${OPD_SELECTIVE_WEIGHT_NLL_HIGH_Q}, loss_q=${OPD_SELECTIVE_WEIGHT_LOSS_LOW_Q}/${OPD_SELECTIVE_WEIGHT_LOSS_MID_Q}/${OPD_SELECTIVE_WEIGHT_LOSS_HIGH_Q}, protect_strong_q=$OPD_SELECTIVE_WEIGHT_PROTECT_STRONG_Q, tier_weights strong/mid/weak=${OPD_SELECTIVE_WEIGHT_PROTECT_STRONG}/${OPD_SELECTIVE_WEIGHT_PROTECT_MID}/${OPD_SELECTIVE_WEIGHT_PROTECT_WEAK}, legacy_weights protect/unclear/${SELECTIVE_WEIGHT_RISK_LABEL}/other=${OPD_SELECTIVE_WEIGHT_PROTECT}/${OPD_SELECTIVE_WEIGHT_UNCLEAR}/${OPD_SELECTIVE_WEIGHT_RISK}/${OPD_SELECTIVE_WEIGHT_OTHER})"
